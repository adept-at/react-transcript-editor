...
// Add up all of the "Start/End" times on the words and set our bounds.
function addTimecodesToLines(wordsList, lines) {
  ...
  const results = lines.map((line) => {
    ...
    jsonLine.speaker = wordsList[startWordCounter].speaker ;

    // Should add Speaker?
    /*if (jsonLine.speaker !== 'TBC' && jsonLine.speaker) {
        jsonLine.text = `<v ${jsonLine.speaker}>${jsonLine.text}</v>`
    }*/
